...
sources="rtl/alu.sv rtl/register_file.sv rtl/decoder.sv rtl/timer.sv rtl/interrupt_controller.sv rtl/csr_file.sv rtl/protection_unit.sv rtl/cpu_indigo.sv rtl/memory_map_indigo.sv sim/cpu_fault_tb.sv"
mkdir -p build
